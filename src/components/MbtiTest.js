...
const questions = [
  ...
  { id: 25, text: { en: "[FIRST_NAME] believes that the most fair way to make decisions is to remove all personal biases and emotions.", ko: "[FIRST_NAME]님은 결정을 내리는 가장 공정한 방법은 모든 개인적 의견과 감정을 제거하는 것이라고 믿습니다." }, category: "T" },
...
function MbtiTest() {
  ...
  const { triggerRefetch } = useMBTIContext();
