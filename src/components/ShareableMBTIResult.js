...
function ShareableMBTIResult({ mbtiResult, mbtiDistribution, getMbtiEmoji, getMbtiDescription, userName, testTakerCount }) {
  ...
  return (
    <div className="flex items-center justify-center" style={{ width: '400px', height: '720px', backgroundColor: '#F0E6FA' }}>
      <div className="bg-white rounded-lg overflow-hidden shadow-lg" style={{ width: '360px', maxHeight: '700px' }}>
        <div className="bg-indigo-600 px-4 py-3">
          <h1 className="text-xl font-bold text-white text-center">{firstName}'s True MBTI</h1>
        </div>
        <div className="p-4 overflow-y-auto" style={{ maxHeight: 'calc(700px - 3rem)' }}>
